...
# allowed FX symbols
SYMBOLS = ['USDCAD', 'EURJPY', 'EURUSD', 'GBPCAD', 'GBPCHF', 'EURCHF', 'USDCHF', 'EURGBP', 'GBPUSD', 'AUDCAD', 'CADCHF', 'NZDJPY', 'NZDUSD', 'NZDCAD', 'NZDCHF', 'GBPCHF', 'AUDUSD', 'GBPJPY', 'USDJPY', 'CHFJPY', 'CADJPY', 'EURCAD', 'AUDJPY', 'EURAUD', 'AUDNZD', 'XAUUSD', 'XAGUSD', 'EURNZD', 'NOW']
